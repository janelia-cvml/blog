...
Examples of computer vision tasks that have been successfully tackled with neural operators include image inpainting, super-resolution, and image segmentation [add citations: Chi, Chu, Wei, Wong].
...
Gege Wen, Zongyi Li, Qirui Long, Kamyar Azizzadenesheli, Anima Anandkumar and Sally M. Benson, "Real-time high-resolution CO2 geological storage prediction using nested Fourier neural operators", 2023. [:link:](https://doi.org/10.48550/arXiv.2210.17051)
