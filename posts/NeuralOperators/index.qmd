...
For solving the inverse problem for a single state, a classical method (middle column) based on finite element methods took 18 hours to compute the solution [@Kovachki2021].
